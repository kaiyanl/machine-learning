...
% Compare the Performance with Different Learning Rate
fprintf('Compare the performance of using different learning rates... \n');
alpha1 = 0.01;
alpha2 = 0.03;
alpha3 = 0.1;
alpha4 = 0.3;
...
plot(1:50, J_history4, 'g');
plot(1:50, J_history5, 'c');
plot(1:50, J_history6, 'm');
